...
CZDetectFaces[ image_Image, opts:OptionsPattern[] ] :=
   CZNonMaxSuppression[FilterRules[ {opts}, Options[ CZNonMaxSuppression ] ] ]@
      CZObjectsDeconformer[ image, {640, 480}, "Fit" ]@CZOutputDecoder[ OptionValue[ Threshold ] ]@
            (trained[ #, TargetDevice->OptionValue[ TargetDevice ] ]&)@CZImageConformer[{640,480},"Fit"]@image;
