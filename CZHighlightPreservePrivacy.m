...
CZHighlightPreservePrivacy[ image_Image ] := HighlightImage[ image, Graphics@{replace[image,#]&/@CZPrivacyRects[ image ], CZDisplayObjects@CZDetectObjects[ image, Method->"RetinaNet" ] } ]
