...
SSDFileName="CZModels/SSDVGG512ReferenceCOCO.hdf";
...
(* Exporting code and setting permissions:
   ...
   CloudExport[ trainedModel, "WLNET","SSDVGG512COCOReference.wlnet" ]
   Options[CloudObject["SSDVGG512COCOReference.wlnet"],Permissions]
   SetOptions[CloudObject["SSDVGG512COCOReference.wlnet"], Permissions\[Rule]"Public"]
*)
